        ...
        <div className="text-white">
            <div className="footer-container p-5">
                <div className="p-4 fs-2 text-danger text-uppercase" >
                    <h3><Nav.Link as={HashLink} to="/home#banner" className="fs-2 text-danger text-uppercase text-decoration-none"><FontAwesomeIcon className="fs-1" icon={faHeartbeat} /> <span className="fw-bold "> </span>HealthCare</Nav.Link></h3>
                </div>
